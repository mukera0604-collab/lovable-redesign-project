  ...
  return (
    <div className="min-h-screen bg-background pb-24">
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        ...
        {/* Promotions */}
        <h2 className="text-xl font-display font-bold text-foreground mb-4">Promotions</h2>
        <div className="card-glass p-8 text-center">
          <p className="text-muted-foreground text-sm">No promotions available at this time.</p>
        </div>
      </div>
